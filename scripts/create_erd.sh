...
# Script to create Entity Relationship Diagram (ERD) for the members app
...
create_erd(){
  echo "Generating ERD..."
  python ${PROJECT_ROOT}manage.py graph_models -I ${INCLUDE_MODELS} -o ${PROJECT_ROOT}/docs/db/erd.${OUTPUT_FORMAT} &&
